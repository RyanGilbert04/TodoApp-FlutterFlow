...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signInUpController = TabController(
      vsync: this,
      length: 2,
      initialIndex: 0,
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Screenshot_2024-09-23_040152.png',
                        ...
                        children: [
                          Align(
                            ...
                            child: TabBar(
                              ...
                              controller: _model.signInUpController,
                              onTap: (i) async {
                                [() async {}, () async {}][i]();
                              },
                            ),
                    ...
                    Stack(
                      children: [
                        if (_model.signInUpCurrentIndex == 1)
                          FFButtonWidget(
                            onPressed: () async {
                        ...
                        if (_model.signInUpCurrentIndex == 0)
                          FFButtonWidget(
                            onPressed: () async {
                              GoRouter.of(context).prepareAuthEvent();
